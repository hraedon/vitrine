...
| :--- | :--- | :--- | :--- | :--- |
| **tenure** | `deed` | 0+ | House and key; tenure subject | Done |
| **rooms** | `floor-plan` | 0+ | Floor plan with openings and door swings | Done |
...
| | `smartphone` | 2010+ | Only for explicitly labelled smartphone records | Done |
...
| **food** | `place-setting` | 0+ | Plate and cutlery for the food subject | Done |
| | `still-life` | dynamic | Gated still life showing named basket items | Done (WI-20) |
| **plumbing** | `hand-pump` | 0+ | Basin and tap; legacy variant key retained | Done |
...
| **internet** | `router` | 0+ | Network globe; does not assert Wi-Fi | Done |
...
Plan 028 adds larger labelled object cards, inset details and tonal shading.
Variant dates describe illustrative style, not measured appliance-model ownership.
Generic telephone records use a receiver; only a smartphone-labelled record
gets a smartphone. The optional US schematic is a secondary navigation aid.
