...
def test_format_minor_default_precision_is_the_currencys_minor_digits() -> None:
    ...
    # JPY's minor unit is the yen: no decimal, and minor == major scaling 1:1.
    assert money.format_minor(65141, "JPY") == "¥65,141"
    assert money.format_amount(29169.0, "JPY", 0) == "¥29,169"
