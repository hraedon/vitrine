...
Corpus: <!-- corpus-status:begin -->27 decade rooms (1900s–2020s), 672 facts, 8 derived facts, 6 Tier D estimates, 61 rendered gaps<!-- corpus-status:end --> (the US wing is complete,
